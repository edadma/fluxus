...
def defaultSelected: String = "selected"
...
def colSpan: String         = "colSpan"
def rowSpan: String         = "rowSpan"
...
def strokeLinecap: String  = "strokeLinecap"
def strokeLinejoin: String = "strokeLinejoin"
def cx: String             = "cx"
def cy: String             = "cy"
def r: String              = "r"
def fillRule: String       = "fillRule"
def clipRule: String       = "clipRule"
def x: String              = "x"
def y: String              = "y"
def rx: String             = "rx"
def ry: String             = "ry"
...
def aria_describedby: String      = "aria-describedby"
def aria_hidden: String           = "aria-hidden"
def aria_expanded: String         = "aria-expanded"
def aria_checked: String          = "aria-checked"
def aria_selected: String         = "aria-selected"
def aria_disabled: String         = "aria-disabled"
def aria_required: String         = "aria-required"
def aria_invalid: String          = "aria-invalid"
def aria_controls: String         = "aria-controls"
def aria_live: String             = "aria-live"
def aria_haspopup: String         = "aria-haspopup"
def aria_pressed: String          = "aria-pressed"
def aria_current: String          = "aria-current"
def aria_busy: String             = "aria-busy"
def aria_owns: String             = "aria-owns"
def aria_activedescendant: String = "aria-activedescendant"
def aria_atomic: String           = "aria-atomic"
...
def canvas(contents: Any*): ElementNode   = createElement("canvas", contents*)
...
def path(contents: Any*): ElementNode     = createElement("path", contents*)
def polyline(contents: Any*): ElementNode = createElement("polyline", contents*)
def polygon(contents: Any*): ElementNode  = createElement("polygon", contents*)
def line(contents: Any*): ElementNode     = createElement("line", contents*)
